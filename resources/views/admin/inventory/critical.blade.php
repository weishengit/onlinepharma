    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <table id="data_table" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <tbody>
                @foreach ($critical_products as $critical_product)
                    <tr>
                        <td>{{ $critical_product->id }}</td>
                        <td>{{ $critical_product->name }}</td>
                        <td>{{ $critical_product->critical_level }}</td>
                        <td>{{ $critical_product->count }}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
