    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div class="flex flex-col">
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        ...
                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div id="header" class="">
                                <h4 id="name" class="text-blue-500 text-2xl font-semibold mb-2">Inventory</h4>
                                <p id="job" class="text-gray-800 mt-2 text-sm">View inventory and stocks.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        href="{{ route('admin.inventory.expiring') }}">

                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div id="header" class="">
                                <h4 id="name" class="text-blue-500 text-2xl font-semibold mb-2">Expiring</h4>
                                <p id="job" class="text-gray-800 mt-2 text-sm">View products in near expiration.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        ...
                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div id="header" class="">
                                <h4 id="name" class="text-blue-500 text-2xl font-semibold mb-2">Inventory Movement</h4>
                                <p id="job" class="text-gray-800 mt-2 text-sm">View Inventory Movement.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        ...
                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div id="header" class="">
                                <h4 id="name" class="text-blue-500 text-2xl font-semibold mb-2">Deliveries</h4>
                                <p id="job" class="text-gray-800 mt-2 text-sm">View Deliveries.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        ...
                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div id="header" class="">
                                <h4 id="name" class="text-blue-500 text-2xl font-semibold mb-2">Settings</h4>
                                <p id="job" class="text-gray-800 mt-2 text-sm">Change Settings.</p>
                            </div>
                        </div>
                    </a>
                </div>
