            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="m-auto">
                        ...
                        <input value="{{ old('name') }}" type="text" name="name" id="name" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="product name...">
                        </div>
                    </div>
                    {{-- Category --}}
                    <div class="m-auto">
                    ...
                    <div class="m-auto">
                        ...
                        <input value="{{ old('generic_name') }}" type="text" name="generic_name" id="generic_name" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="example: 'paracetamol', 'ibuprofen'">
                        </div>
                    </div>
                    {{-- Drug Class --}}
                    <div class="m-auto">
                        ...
                        <input value="{{ old('drug_class') }}" type="text" name="drug_class" id="drug_class" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="example: 'Analgesics (Non-Opioid)', 'Antipyretics' ,'NSAIDs'">
                        </div>
                    </div>
                    {{-- Description --}}
                    <div>
                        ...
                        <div class="mt-1">
                          <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="put product description here">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    {{-- Price --}}
                    <div class="m-auto">
                        ...
                        <input value="{{ old('price') }}" type="text" name="price" id="price" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="example: 5.00, 80.00">
                        </div>
                    </div>
                    {{-- Stock --}}
                    <div class="m-auto">
                    ...
                    <div class="m-auto">
                        ...
                        <input value="{{ old('measurement') }}" type="text" name="measurement" id="measurement" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="example: 100mg, 20ml, 5g">
                        </div>
                    </div>
                    {{-- Prescription --}}
                    <div class="m-auto">
