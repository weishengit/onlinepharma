...
<div class="container w-full mx-auto pt-20">
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        {{-- CONTENT --}}
        <form
            action="{{ route('admin.delivery.store', ['cashier' => $order->id]) }}"
            method="post">
            @csrf
            <div class="flex flex-wrap -mx-1 overflow-hidden">
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">{{ $order->ref_no }}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">{{ $order->created_at }}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">{{ $order->contact }}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">{{ $order->address}}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">{{ $order->customer }}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <h3 class="text-xl p-auto m-auto">&#8369;{{ $order->amount_due }}</h3>
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <input id="driver_id" name="driver_id" type="text" placeholder="Courier ID" value="{{ old('driver_id') }}">
                    </div>
                </div>
                ...
                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        ...
                        <input id="driver_name" name="driver_name" type="text" placeholder="Courier Name" value="{{ old('driver_name') }}">
                    </div>
                </div>

                <div class="my-1 px-1 w-1/2 overflow-hidden">
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border">
                        <label class="text-3xl p-auto m-auto">Delivery:</label>
