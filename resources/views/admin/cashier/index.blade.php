        ...
        <div class="flex flex-col">
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        href="{{ route('admin.cashier.show', ['cashier' => 'pending']) }}">

                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div>
                                <h4 class="text-blue-500 text-2xl font-semibold mb-2">
                                    Accepted Orders
                                    <span class="badge mb-3 bg-blue-600 rounded-full px-2 py-1 text-center object-right-top text-white text-xs mr-1">
                                        {{ $pending_count }}
                                    </span>
                                </h4>
                                <p class="text-gray-800 mt-2 text-sm">Show all currently pending orders.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <a
                        href="{{ route('admin.cashier.show', ['cashier' => 'dispatched']) }}">
                        ...
                        <div class="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
                            <div>
                                ...
                                <p class="text-gray-800 mt-2 text-sm">Show all currently disptached orders.</p>
                            </div>
                        </div>
                    </a>
                </div>
